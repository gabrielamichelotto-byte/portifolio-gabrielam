...
T = {
  ...
  "c0_res":  {"PT": "Dashboard ao vivo com faturamento, margem, metas, giro de estoque, segmentação de clientes e curva ABC — publicado e acessível pelo link abaixo.",
              "EN": "Live dashboard covering revenue, margin, sales targets, stock rotation, customer segmentation and ABC curve — published and accessible via the link below."},
  "c5_tag":  {"PT": "HTML · Chart.js · Python · GitHub Pages", "EN": "HTML · Chart.js · Python · GitHub Pages"},
  "c5_name": {"PT": "Toronto LTDA — Painéis Analíticos Interativos",
              "EN": "Toronto LTDA — Interactive Analytical Panels"},
  "c5_ctx":  {"PT": "Expandir o projeto Toronto LTDA com painéis standalone de análise comercial, cada um acessível individualmente e com navegação cruzada.",
              "EN": "Expand the Toronto LTDA project with standalone analytical panels, each independently accessible with full cross-navigation."},
  "c5_act":  {"PT": "Desenvolvi 4 painéis HTML independentes com Chart.js: Funil de Vendas, Conversão de Atividades, Cancelamentos & Devoluções e Mix de Produtos — cada um gerado por script Python com dados do SQLite e publicado no GitHub Pages.",
              "EN": "Built 4 independent HTML panels with Chart.js: Sales Funnel, Activity Conversion, Cancellations & Returns, and Product Mix — each generated by a Python script from SQLite data and published on GitHub Pages."},
  "c5_res":  {"PT": "Hub de painéis ao vivo com navegação cruzada completa — funil, conversão, cancelamentos e mix de produtos em um único acesso.",
              "EN": "Live panel hub with full cross-navigation — funnel, conversion, cancellations and product mix accessible in one place."},
  ...
  "c2_res":  {"PT": "Gestão orientada por dados — contribuição direta para crescimento expressivo de receita acima da meta.",
              "EN": "Data-driven management — direct contribution to above-target revenue growth."},
  ...
  "c7_tag":  {"PT": "IA · Automação · CRM · Funil de Vendas",  "EN": "AI · Automation · CRM · Sales Funnel"},
  "c7_name": {"PT": "Ecossistema de 7 Agentes de IA — Operação Comercial",
              "EN": "7-Agent AI Ecosystem — Sales Operations"},
  "c7_ctx":  {"PT": "Operação comercial remota de um estúdio de design internacional: prospecção, propostas e follow-up consumiam a operação inteira no manual.",
              "EN": "Remote sales operation for an international design studio: prospecting, proposals and follow-ups consumed the entire operation when done manually."},
  "c7_act":  {"PT": "Construí um ecossistema de 7 agentes de IA que operam o funil ponta a ponta: prospecção, qualificação de leads por ICP, outreach, geração de propostas, follow-up, tracking de envios e diário de bordo — com pipeline em CRM e dashboard gerado por automação.",
...
painel_bi_img_html = (
    f'<img src="data:image/png;base64,{painel_bi_b64}" '
    f'alt="Painel BI Toronto LTDA" '
    f'style="width:100%;border-radius:6px;box-shadow:0 8px 32px rgba(0,0,0,0.12);display:block;">'
    if painel_bi_b64 else ""
)
featured_painel_bi = f"""
<div class="case-featured">
  <div>
    <p class="case-tag">{t("c5_tag")}</p>
    <p class="case-name">{t("c5_name")}</p>
